...
uploaded_files = st.file_uploader("📂 Upload files", type=["pdf", "docx", "xlsx", "csv"], accept_multiple_files=True)
...
def generate_summary(text):
    try:
        truncated = text[:12000]  # stay under token limits (~4 chars/token)
